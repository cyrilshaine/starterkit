...
$data[$x] = array(
    ...
    <input type='hidden' id='tbl_col1$x' value='Col1 Data for row $x' />
    <input type='hidden' id='tbl_col2$x' value='Col2 Data for row $x' />
    ...
    2=>"<button onclick='Edit_funct($x)'>Edit</button>"
