<?php $this->load->view("a_pages/personnel_registration/a_js"); $this->load->view("a_pages/personnel_registration/a_css"); 
?>
<?php 
...
<div id='t_content'>
<div id='t_header'>
<button class='btn btn-primary' style='<?= $st; ?>' onclick="SYS_personnel_registration_form()"><span class='glyphicon glyphicon-plus'></span>Register</button>
</div>
...
<th style='width:55px;'>Personnel ID</th>
